        ...
        messages: [
          {
            ...
            content: [
              ...
              "  If the 'feedback' field is non-empty, treat it as a HIGH-PRIORITY user override.",
              "  It supersedes any prior assumption about tone, audience, key message, hashtag direction, or image scene whenever it conflicts.",
              "  Concretely: rewrite copyText, hashtags, imagePrompt, and tone so the feedback is the dominant influence — do NOT water it down or merge it timidly with the original direction.",
              "  Reflect feedback in BOTH copyText (wording / emotion / structure) AND imagePrompt (scene / colors / typography mood) when applicable.",
              "  Format and safety rules above still apply.",
