...
const extractionSchema = {
  ...
  schema: {
    ...
    properties: {
      storeName: {
        type: "string",
        description: "The store/brand name shown prominently on the image, in Korean if present. Empty string if not visible."
      },
      dish: {
        type: "string",
        description: "The featured menu item or dish name on the image, in Korean if present. Empty string if not visible."
      },
      benefit: {
        type: "string",
        description: "The promotional benefit phrase such as discount, event, new-menu badge, or call-to-action, in Korean if present. Empty string if not visible."
      },
      koreanText: {
        type: "array",
        items: { type: "string" },
